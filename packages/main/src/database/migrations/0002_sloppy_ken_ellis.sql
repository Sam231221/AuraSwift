...
--> statement-breakpoint
CREATE UNIQUE INDEX `shift_validation_issues_public_id_unique` ON `shift_validations` (`public_id`);--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_app_settings`("key", "value", "created_at", "updated_at") SELECT "key", "value", "created_at", "updated_at" FROM `app_settings`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_audit_logs`("id", "userId", "action", "resource", "resourceId", "entityType", "entityId", "details", "ipAddress", "terminalId", "timestamp", "created_at") SELECT "id", "userId", "action", "resource", "resourceId", "entityType", "entityId", "details", "ipAddress", "terminalId", "timestamp", "created_at" FROM `audit_logs`;--> statement-breakpoint
DROP TABLE `audit_logs`;--> statement-breakpoint
ALTER TABLE `__new_audit_logs` RENAME TO `audit_logs`;--> statement-breakpoint
CREATE TABLE `__new_breaks` (
	`id` text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_breaks`("id", "shiftId", "userId", "type", "startTime", "endTime", "duration", "isPaid", "status", "notes", "created_at", "updated_at") SELECT "id", "shiftId", "userId", "type", "startTime", "endTime", "duration", "isPaid", "status", "notes", "created_at", "updated_at" FROM `breaks`;--> statement-breakpoint
DROP TABLE `breaks`;--> statement-breakpoint
ALTER TABLE `__new_breaks` RENAME TO `breaks`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_businesses`("id", "name", "ownerId", "email", "phone", "website", "address", "country", "city", "postalCode", "vatNumber", "businessType", "currency", "timezone", "isActive", "created_at", "updated_at") SELECT "id", "name", "ownerId", "email", "phone", "website", "address", "country", "city", "postalCode", "vatNumber", "businessType", "currency", "timezone", "isActive", "created_at", "updated_at" FROM `businesses`;--> statement-breakpoint
...
CREATE TABLE `__new_cash_drawer_counts` (
	`id` text PRIMARY KEY NOT NULL,
	`business_id` text NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_cash_drawer_counts`("id", "business_id", "created_at", "updated_at", "shift_id", "count_type", "expected_amount", "counted_amount", "variance", "notes", "counted_by", "timestamp") SELECT "id", "business_id", "created_at", "updated_at", "shift_id", "count_type", "expected_amount", "counted_amount", "variance", "notes", "counted_by", "timestamp" FROM `cash_drawer_counts`;--> statement-breakpoint
DROP TABLE `cash_drawer_counts`;--> statement-breakpoint
ALTER TABLE `__new_cash_drawer_counts` RENAME TO `cash_drawer_counts`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_categories`("id", "name", "parent_id", "description", "vat_category_id", "business_id", "sort_order", "color", "image", "is_active", "created_at", "updated_at") SELECT "id", "name", "parent_id", "description", "vat_category_id", "business_id", "sort_order", "color", "image", "is_active", "created_at", "updated_at" FROM `categories`;--> statement-breakpoint
...
CREATE TABLE `__new_clock_events` (
	`id` text PRIMARY KEY NOT NULL,
	`userId` text NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_clock_events`("id", "userId", "terminalId", "locationId", "type", "timestamp", "method", "status", "geolocation", "ipAddress", "notes", "created_at", "updated_at") SELECT "id", "userId", "terminalId", "locationId", "type", "timestamp", "method", "status", "geolocation", "ipAddress", "notes", "created_at", "updated_at" FROM `clock_events`;--> statement-breakpoint
DROP TABLE `clock_events`;--> statement-breakpoint
ALTER TABLE `__new_clock_events` RENAME TO `clock_events`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_discounts`("id", "name", "description", "type", "value", "businessId", "applicableTo", "categoryIds", "productIds", "buyQuantity", "getQuantity", "getDiscountType", "getDiscountValue", "minPurchaseAmount", "minQuantity", "maxDiscountAmount", "startDate", "endDate", "isActive", "usageLimit", "usageCount", "perCustomerLimit", "priority", "daysOfWeek", "timeStart", "timeEnd", "requiresCouponCode", "couponCode", "combinableWithOthers", "created_at", "updated_at", "createdBy") SELECT "id", "name", "description", "type", "value", "businessId", "applicableTo", "categoryIds", "productIds", "buyQuantity", "getQuantity", "getDiscountType", "getDiscountValue", "minPurchaseAmount", "minQuantity", "maxDiscountAmount", "startDate", "endDate", "isActive", "usageLimit", "usageCount", "perCustomerLimit", "priority", "daysOfWeek", "timeStart", "timeEnd", "requiresCouponCode", "couponCode", "combinableWithOthers", "created_at", "updated_at", "createdBy" FROM `discounts`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_products`("id", "name", "description", "base_price", "cost_price", "sku", "barcode", "plu", "image", "category_id", "product_type", "sales_unit", "uses_scale", "price_per_kg", "is_generic_button", "generic_default_price", "track_inventory", "stock_level", "min_stock_level", "reorder_point", "vat_category_id", "business_id", "is_active", "allow_price_override", "allow_discount", "created_at", "updated_at") SELECT "id", "name", "description", "base_price", "cost_price", "sku", "barcode", "plu", "image", "category_id", "product_type", "sales_unit", "uses_scale", "price_per_kg", "is_generic_button", "generic_default_price", "track_inventory", "stock_level", "min_stock_level", "reorder_point", "vat_category_id", "business_id", "is_active", "allow_price_override", "allow_discount", "created_at", "updated_at" FROM `products`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_schedules`("id", "staffId", "businessId", "startTime", "endTime", "status", "assignedRegister", "notes", "created_at", "updated_at") SELECT "id", "staffId", "businessId", "startTime", "endTime", "status", "assignedRegister", "notes", "created_at", "updated_at" FROM `schedules`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_sessions`("id", "userId", "token", "expiresAt", "created_at", "updated_at") SELECT "id", "userId", "token", "expiresAt", "created_at", "updated_at" FROM `sessions`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_shifts`("id", "scheduleId", "cashierId", "businessId", "startTime", "endTime", "status", "startingCash", "finalCashDrawer", "expectedCashDrawer", "cashVariance", "totalSales", "totalTransactions", "totalRefunds", "totalVoids", "notes", "created_at", "updated_at") SELECT "id", "scheduleId", "cashierId", "businessId", "startTime", "endTime", "status", "startingCash", "finalCashDrawer", "expectedCashDrawer", "cashVariance", "totalSales", "totalTransactions", "totalRefunds", "totalVoids", "notes", "created_at", "updated_at" FROM `shifts`;--> statement-breakpoint
DROP TABLE `shifts`;--> statement-breakpoint
ALTER TABLE `__new_shifts` RENAME TO `shifts`;--> statement-breakpoint
CREATE TABLE `__new_time_corrections` (
	`id` text PRIMARY KEY NOT NULL,
	`clockEventId` text,
	`shiftId` text,
	`userId` text NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_time_corrections`("id", "clockEventId", "shiftId", "userId", "correctionType", "originalTime", "correctedTime", "timeDifference", "reason", "requestedBy", "approvedBy", "status", "created_at", "updated_at") SELECT "id", "clockEventId", "shiftId", "userId", "correctionType", "originalTime", "correctedTime", "timeDifference", "reason", "requestedBy", "approvedBy", "status", "created_at", "updated_at" FROM `time_corrections`;--> statement-breakpoint
DROP TABLE `time_corrections`;--> statement-breakpoint
ALTER TABLE `__new_time_corrections` RENAME TO `time_corrections`;--> statement-breakpoint
CREATE TABLE `__new_time_shifts` (
	`id` text PRIMARY KEY NOT NULL,
	`userId` text NOT NULL,
	`businessId` text NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_time_shifts`("id", "userId", "businessId", "clockInId", "clockOutId", "scheduleId", "status", "totalHours", "regularHours", "overtimeHours", "breakDuration", "notes", "created_at", "updated_at") SELECT "id", "userId", "businessId", "clockInId", "clockOutId", "scheduleId", "status", "totalHours", "regularHours", "overtimeHours", "breakDuration", "notes", "created_at", "updated_at" FROM `time_shifts`;--> statement-breakpoint
DROP TABLE `time_shifts`;--> statement-breakpoint
ALTER TABLE `__new_time_shifts` RENAME TO `time_shifts`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_transaction_items`("id", "transactionId", "productId", "productName", "quantity", "unitPrice", "totalPrice", "refundedQuantity", "weight", "discountAmount", "appliedDiscounts", "created_at") SELECT "id", "transactionId", "productId", "productName", "quantity", "unitPrice", "totalPrice", "refundedQuantity", "weight", "discountAmount", "appliedDiscounts", "created_at" FROM `transaction_items`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_users`("id", "username", "email", "password_hash", "pin_hash", "salt", "firstName", "lastName", "businessName", "role", "businessId", "permissions", "lastLoginAt", "isActive", "login_attempts", "locked_until", "address", "created_at", "updated_at") SELECT "id", "username", "email", "password_hash", "pin_hash", "salt", "firstName", "lastName", "businessName", "role", "businessId", "permissions", "lastLoginAt", "isActive", "login_attempts", "locked_until", "address", "created_at", "updated_at" FROM `users`;--> statement-breakpoint
DROP TABLE `users`;--> statement-breakpoint
ALTER TABLE `__new_users` RENAME TO `users`;--> statement-breakpoint
CREATE UNIQUE INDEX `users_username_unique` ON `users` (`username`);--> statement-breakpoint
CREATE UNIQUE INDEX `users_email_unique` ON `users` (`email`);--> statement-breakpoint
CREATE TABLE `__new_vat_categories` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_vat_categories`("id", "name", "rate_percent", "code", "description", "business_id", "is_default", "is_active", "created_at", "updated_at") SELECT "id", "name", "rate_percent", "code", "description", "business_id", "is_default", "is_active", "created_at", "updated_at" FROM `vat_categories`;--> statement-breakpoint
DROP TABLE `vat_categories`;--> statement-breakpoint
ALTER TABLE `__new_vat_categories` RENAME TO `vat_categories`;--> statement-breakpoint

...
INSERT INTO `__new_cart_items`("id", "cart_session_id", "product_id", "category_id", "item_name", "item_type", "quantity", "weight", "unit_of_measure", "unit_price", "total_price", "tax_amount", "batch_id", "batch_number", "expiry_date", "age_restriction_level", "age_verified", "scale_reading_weight", "scale_reading_stable", "added_at", "updated_at") SELECT "id", "cart_session_id", "product_id", "category_id", "item_name", "item_type", "quantity", "weight", "unit_of_measure", "unit_price", "total_price", "tax_amount", "batch_id", "batch_number", "expiry_date", "age_restriction_level", "age_verified", "scale_reading_weight", "scale_reading_stable", "added_at", "updated_at" FROM `cart_items`;--> statement-breakpoint
